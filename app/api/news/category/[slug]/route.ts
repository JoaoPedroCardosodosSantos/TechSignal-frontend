/**
 * API Route: /api/news/category/[slug]
 * Retorna noticias filtradas por categoria (tag)
 * Suporta paginacao via query params: page e limit
 */
...
// Dados mockados (em producao, viria de um banco de dados)
const allNews: NewsItem[] = [
  ...
  // Noticias adicionais para categorias com mais conteudo
  {
    id: 16,
    title: 'Processadores ARM Desafiam Dominio da Intel',
    summary: 'Arquitetura ARM ganha espaco em servidores e desktops, ameacando a hegemonia tradicional da Intel no mercado.',
    content: 'A arquitetura ARM esta expandindo rapidamente sua presenca no mercado de computadores pessoais e servidores, territorios tradicionalmente dominados pela Intel. Com chips que oferecem melhor eficiencia energetica e desempenho competitivo, fabricantes estao migrando para ARM em numeros cada vez maiores.',
    image_url: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=1200&h=800&fit=crop',
    tag: 'Hardware',
    published_at: '2026-02-03',
    slug: 'processadores-arm-desafiam-intel'
  },
  {
    id: 17,
    title: 'GPUs de Nova Geracao Prometem Revolucionar Graficos',
    summary: 'NVIDIA e AMD anunciam placas de video com ray tracing em tempo real e suporte a IA generativa integrada.',
    content: 'As novas geracoes de GPUs estao trazendo capacidades que pareciam impossiveis ha poucos anos. Ray tracing em tempo real, upscaling com IA e processamento de modelos de linguagem diretamente na placa de video sao apenas algumas das novidades.',
    image_url: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=1200&h=800&fit=crop',
    tag: 'Hardware',
    published_at: '2026-02-01',
    slug: 'gpus-nova-geracao-graficos'
  },
  {
    id: 18,
    title: 'IA Agentes Autonomos Transformam Produtividade',
    summary: 'Nova geracao de assistentes de IA pode executar tarefas complexas de forma independente, mudando o trabalho.',
    content: 'Os agentes de IA autonomos representam a proxima fronteira da inteligencia artificial. Diferente de chatbots tradicionais, esses sistemas podem planejar, executar e revisar tarefas complexas com minima supervisao humana.',
    image_url: 'https://images.unsplash.com/photo-1676299081847-824916de030a?w=1200&h=800&fit=crop',
    tag: 'IA',
    published_at: '2026-01-28',
    slug: 'ia-agentes-autonomos-produtividade'
  },
  {
    id: 19,
    title: 'Modelos de Linguagem Multimodais Dominam o Mercado',
    summary: 'IA capaz de entender texto, imagem, audio e video simultaneamente abre novas possibilidades de aplicacao.',
    content: 'Os modelos multimodais estao redefinindo o que e possivel fazer com inteligencia artificial. Sistemas capazes de processar e gerar conteudo em multiplos formatos estao encontrando aplicacoes em areas que vao desde educacao ate diagnostico medico.',
    image_url: 'https://images.unsplash.com/photo-1684487747720-1ba29cda82f8?w=1200&h=800&fit=crop',
    tag: 'IA',
    published_at: '2026-01-25',
    slug: 'modelos-linguagem-multimodais'
  },
  {
    id: 20,
    title: 'Startups de Healthtech Atraem Bilhoes em Investimentos',
    summary: 'Setor de tecnologia em saude vive boom de investimentos com solucoes inovadoras de diagnostico e tratamento.',
    content: 'O setor de healthtech esta vivendo um momento de ouro, com startups atraindo bilhoes em investimentos para desenvolver solucoes que prometem revolucionar a medicina. De diagnostico por IA a terapias geneticas personalizadas, as possibilidades parecem infinitas.',
    image_url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1200&h=800&fit=crop',
    tag: 'Startups',
    published_at: '2026-01-30',
    slug: 'startups-healthtech-investimentos'
  }
]
...
export async function GET(
  ...
  // Busca parametros de paginacao da URL
  const { searchParams } = new URL(request.url)
  const page = parseInt(searchParams.get('page') || '1', 10)
  const limit = parseInt(searchParams.get('limit') || '6', 10)
  
  // Valida o slug da categoria
  ...
  // Filtra noticias pela categoria (tag)
  const filteredNews = allNews.filter(
    news => news.tag.toLowerCase() === categoryName.toLowerCase()
  )
