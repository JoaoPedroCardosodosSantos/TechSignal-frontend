...
/**
 * Pagina de Cadastro
 * Pagina de registro do blog TechPulse
 * Visual moderno com tema roxo, dark mode por padrao
 */
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background p-4 py-8">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 right-0 h-80 w-80 rounded-full bg-accent/15 blur-3xl" />
        {/* Gradiente inferior esquerdo */}
        <div className="absolute bottom-20 left-10 h-64 w-64 rounded-full bg-primary/10 blur-3xl" />
        {/* Gradiente extra para a pagina de registro */}
        <div className="absolute top-1/2 right-20 h-72 w-72 -translate-y-1/2 rounded-full bg-accent/10 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Junte-se a comunidade TechPulse
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-xl shadow-primary/5 sm:p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 rounded-lg border border-border bg-transparent px-4 py-2.5 text-sm font-medium transition-colors hover:bg-secondary"
            >
